...
tags$div(class = "category-row",
  ...
  tags$div( 
    ...
    tags$a(href = "posts/index.html#category=Graficos",
      tags$img(
        href = "posts/index.html#category=Graficos",
  ...
  tags$h4(style = "text-align:center;",
      tags$a(
        class = "white",
        href = "posts/index.html#category=Graficos", "Graficos"))),
  ...
  tags$h4(style = "text-align:center",
      tags$a(
        class = "white",
        href = "posts/index.html#category=Mapas", "Mapas"))),
  
  tags$div( 
    class = "category-column",
    tags$a(href = "posts/index.html#category:Manipulacao",
      tags$img(
        href = "posts/index.html#category=Manipulacao",
  ...
  tags$h4(style = "text-align:center",
      tags$a(
        class = "white",
        href = "posts/index.html#category=Manipulacao", "Manipulacao")))
...
tags$div(class = "category-row",
  ...
  tags$div( 
    class = "category-column",
    tags$a(href = "posts_py/index.html#category=Graficos",
      tags$img(
        href = "posts_py/index.html#category=Graficos",
        src = "Imagens/stats.svg",
        style = "color:#fff !important;",
        class = "category-image honey-white"
  )),
  tags$h4(style = "text-align:center;",
      tags$a(
        class = "white",
        href = "posts_py/index.html#category=Graficos", "Graficos"))),
  
  tags$div( 
    class = "category-column",
    tags$a(href = "posts_py/index.html#category=Mapas",
      tags$img(
        href = "posts_py/index.html#category=Mapas",
        src = "Imagens/brazil.svg",
        style = "color:#fff !important;",
        class = "category-image honey-white"
  )),
  tags$h4(style = "text-align:center",
      tags$a(
        class = "white",
        href = "posts_py/index.html#category=Mapas", "Mapas"))),
  
  tags$div( 
    class = "category-column",
    tags$a(href = "posts_py/index.html#category:Manipulacao",
      tags$img(
        href = "posts_py/index.html#category=Manipulacao",
        src = "Imagens/database-management.svg",
        style = "color:#fff !important;",
        class = "category-image honey-white"
  )),
  tags$h4(style = "text-align:center",
      tags$a(
        class = "white",
        href = "posts_py/index.html#category=Manipulacao", "Manipulacao")))
