...
Projeto voltado a visualização de dados no curso de [Estatística](https://estatistica.uff.br) - UFF. 
...
<span> Projeto de Monitoria da [Estatística](https://estatistica.uff.br) voltada para a matéria de Visualização de Dados(Get-00100) com o objetivo de mostra a funcionalidade da ferramenta Quarto para website, utilizando R.</span><br>
