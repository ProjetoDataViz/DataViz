...
description: |
  Primeiro Workshop para o projeto data viz
author: "Ana Li"
date: "01/12/2025"
...
#### Author
[Ana li](https://github.com/lesuff/1-Workshop-Explorando-o-Tidyverse)  
...
Encontre o material [aqui](https://github.com/lesuff/1-Workshop-Explorando-o-Tidyverse);
but in practice there are only a few that we use routinely. Our default at ALA labs
is to use `viridis` for continuous scales, because  it's color-blind friendly, 
